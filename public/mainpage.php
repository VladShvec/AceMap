...
<div id="main_page_content">
    ...
    <div id="main_container">
        <div id="menu_list">
            ...
            <!--                <button class="menu_button btn btn-info">Переместить маркер</button>-->
        </div>
        <div class="menu">
            <div class="marker-position" style="display: none">click on the map, move the marker, click on the marker
            </div>
            ...
            <div class="form_and_buttons">
                ...
                <button class="menu_button_add btn btn-info" onclick="addMarkerButton(event)">Добавить маркер</button>
                <button class="menu_button_add btn btn-info" id="bt" onclick="deleteMarker(event)">Удалить маркер
                    <button class="menu_button_add btn btn-info" id="bt" onclick="showAllMarkers()">Показать все маркеры
                    </button>
            </div>
        </div>
